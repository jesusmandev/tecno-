...
export const mockCombos: ComboItem[] = [
  ...
  {
    id: "combo-estuche-silicona-vidrio-xiaomi",
    title: "Estuche Funda Forro En Silicona + Vidrio Premium Para Xiaomi",
    subtitle: "6 CUOTAS DE $5.526 COP",
    description: "Trae una funda de silicona con interior gamuzado que repele la suciedad y un vidrio premium con kit de instalación.",
    price: 33_150,
    compareAtPrice: null,
    imageUrl: "/products/combos/combo-forro-vidrio-xiaomi.png",
    whatsappText: "Hola Tecno+, quiero el Estuche Funda Forro En Silicona + Vidrio Premium Para Xiaomi",
  },
];
