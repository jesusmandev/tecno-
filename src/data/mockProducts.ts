...
export const mockProducts: Product[] = [
  // --- CELULARES ---
  {
    ...
    badge: "Top ventas",
    badgeStyle: "dark",
    whatsappText: "Hola Tecno+, quiero comprar iPhone 17 Pro Max por $4.500.000 COP",
  ...
  },
  {
    ...
    description: "256GB · Chip A18 Pro · Seminuevo",
    descriptionHtml:
      "<p>El smartphone insignia de Apple con procesador <strong>A18 Pro</strong>, pantalla Super Retina XDR de 6.9 pulgadas y diseño en titanio grado 5. En estado seminuevo 10/10 certificado.</p><ul><li>256GB de almacenamiento de alta velocidad</li><li>Chip A18 Pro con GPU de 6 núcleos y Apple Intelligence</li><li>Cámara Fusion de 48MP con teleobjetivo 5x</li><li>Botón de Control de Cámara táctil y háptico</li><li>Garantía directa con Tecno+</li></ul>",
    vendor: "Apple",
    productType: "Celulares",
    category: "celulares",
    badge: "Seminuevo",
    badgeStyle: "dark",
    whatsappText: "Hola Tecno+, quiero comprar el iPhone 16 Pro Max 256GB Seminuevo por $2.990.000 COP",
    tags: ["apple", "iphone", "iphone-16", "pro-max", "celular", "gama-alta", "seminuevo"],
    price: 2_990_000,
    ...
    variants: [
      {
        id: "var-ip16pm-256",
        title: "256GB - Titanio Desierto (Seminuevo)",
        availableForSale: true,
        price: 2_990_000,
        compareAtPrice: 3_490_000,
      },
      {
        id: "var-ip16pm-512",
        title: "512GB - Titanio Negro (Seminuevo)",
        availableForSale: true,
        price: 3_350_000,
  ...
  },
  {
    ...
    description: "256GB · Chip A18 Pro · Seminuevo",
    descriptionHtml:
      "<p>El smartphone insignia de Apple con procesador <strong>A18 Pro</strong>, pantalla Super Retina XDR de 6.9 pulgadas y diseño en titanio grado 5. En estado seminuevo 10/10 certificado con garantía Tecno+.</p><ul><li>256GB de almacenamiento ultrarrápido</li><li>Chip A18 Pro con GPU de 6 núcleos y Apple Intelligence</li><li>Cámara Fusion de 48MP con teleobjetivo 5x</li><li>Botón de Control de Cámara táctil y háptico</li><li>Garantía directa con Tecno+</li></ul>",
    vendor: "Apple",
    productType: "Celulares",
    category: "gaming",
    badge: "Seminuevo",
    badgeStyle: "dark",
    whatsappText: "Hola Tecno+, quiero comprar el iPhone 16 Pro Max 256GB Seminuevo por $2.990.000 COP",
    tags: ["apple", "iphone", "iphone-16", "celular", "gama-alta", "seminuevo"],
    price: 2_990_000,
    compareAtPrice: 3_490_000,
    currencyCode: "COP",
    featuredImage: {
  ...
  },
  {
    ...
    badge: "Tecnología",
    badgeStyle: "light",
    whatsappText: "Hola Tecno+, quiero comprar Redmi Watch 5 Active por $300.000 COP",
  ...
  },
  {
    ...
    badge: "Tecnología",
    badgeStyle: "light",
    whatsappText: "Hola Tecno+, quiero comprar TvBox G7 Edición Araña por $160.000 COP",
...
export const mockCombos: ComboItem[] = [
  ...
  },
  {
    ...
    title: "Combo Celular Samsung Galaxy A07 64GB + Vidrio Templado y Forro de Silicona",
...
export const gamerFeature = {
  eyebrow: "MUNDO GAMER",
  title: "Consola Game Stick Pro 4K",
  description:
    "Juega donde quieras: compatible con televisores, computadores y pantallas HDMI. Incluye 2 controles inalámbricos, miles de juegos retro clásicos y resolución 4K Plug & Play.",
  price: "$180.000 COP",
  images: [
